...
<html>
	...
	<body>
		...
		<div id="div1" style="border-color: #0054AA; height: 1000px;">
			...
			<div id="page">
				<form method="post"
					action="${pageContext.request.contextPath }/user/updateGroup.do">
					<table class="table" cellspacing="1" cellpadding="2" width="94%"
						...
						<tr class="td_bg">
							...
							<td colspan="3"
								...
								<input type="text" name="groupName" id="groupName" size="60"
									value="${userInterestGroup.groupName }" />
							</td>
						</tr>
						<tr height="30" class="td_bg">
							...
							<td colspan="3" style='border-top: 1px dotted #C2CCE3;'>
								<textarea rows="5" cols="60" name="groupNotice" id="groupNotice">${userInterestGroup.groupNotice }</textarea>
							</td>
						</tr>
					</table>
