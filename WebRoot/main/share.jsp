			...
			<tr>
				...
				<td class=righttopcenter>
					...
					<img border=0
						...
						align=absmiddle>
					<a href="${pageContext.request.contextPath }/queryShares.do"><font
					...
					<table border=0 width='100%' height='100%'>
						<tr>
																					...
																					<TR>
																						<TD align=middle style='padding: 4px'>
																							<img border="0"
																								...
																								src='${pageContext.request.contextPath }/images/xingquxiaozu.jpg' />
																						</TD>
																					</TR>
																				</TABLE>
																			</TD>
							...
							<td valign=top style='border-left: 1px dotted #C2CCE3;'
								class=artbg>
								<c:forEach var="mainShare" items="${mainss }">
									<table border=0 width='100%' cellspacing='0' cellpadding='0'>
										<tr>
											<td
												style='border-top: 1px dotted #C2CCE3; height: 24; width: 300px''>
												&nbsp; [${mainShare.subject.subjectName }]&nbsp;
												<a
													href='${pageContext.request.contextPath }/queryShare.do?id=${mainShare.id }'><font
													color='#000000'><c:if
															test="${fn:length(mainShare.shareName)>15}">
													${fn:substring(mainShare.shareName, 0, 15)}...
												</c:if> <c:if test="${fn:length(mainShare.shareName)<=15}">
												${mainShare.shareName }
												</c:if> </font> </a>
											</td>
											<td width=60 style='border-top: 1px dotted #C2CCE3;'>
												<fmt:formatDate value="${mainShare.shareDate }"
													pattern="yyyy-MM-dd" />
											</td>
										</tr>
									</table>
