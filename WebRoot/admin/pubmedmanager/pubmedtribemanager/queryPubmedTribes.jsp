...
<html>
	<head>
		...
		<script type="text/javascript">
			function adminAddPubmedTribe(){
				window.location.href="${pageContext.request.contextPath}/admin/pubmedmanager/pubmedtribemanager/addPubmedTribe.jsp";
			}
			var flag=false;
			function selectAll(){
	...
	<body>
		<form method="post"
			action="${pageContext.request.contextPath}/admin/deletePubmedTribes.do">
			<table class="table" cellspacing="1" cellpadding="2" width="99%"
				...
				<c:forEach var="pubmedTribe" items="${pubmedTribes }">
					<tr class="td_bg" align="center">
						<td>
							<input type="checkbox" name="ids" value="${pubmedTribe.id }"
						...
						<td>
							<a style="color: red"
								href="${pageContext.request.contextPath }/admin/queryPubmedTribe.do?id=${pubmedTribe.id }">查看</a>
						</td>
						<td>
							<a style="color: red"
								href="${pageContext.request.contextPath }/admin/updatePubmedTribe.do?id=${pubmedTribe.id }">修改</a>
						</td>
					</tr>
				</c:forEach>
			</table>
		...
		<div align="center">
			...
			<input value="添加考研部落信息" type="button"
				onclick="adminAddPubmedTribe();" />
		</div>
	</body>
</html>
