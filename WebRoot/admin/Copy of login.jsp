...
<table id="__01" width="1003" height="613" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<tr><td>验证码:</td><td><input id="validateImg" type="text" name="validateImg" style="width:50px; height:17px; background-color:#292929; border:solid 1px #7dbad7; font-size:12px; color:#6cd0ff"></td><td><img src="${pageContext.request.contextPath }/validateImage" onclick="refreshImg();" id="changeImg"/></td></tr>
