...
<html>
	...
	<body>
		<form method="post"
			action="${pageContext.request.contextPath }/admin/addSutraBook.do">
			<table class="table" cellspacing="1" cellpadding="2" width="99%"
				...
				<tr class="td_bg">
					...
					<td colspan="3">
						<input type="text" name="bookName" id="bookName" size="80" />
					</td>
				</tr>
				...
				<tr class="td_bg">
					<td colspan="4">
						<textarea name="bookSynopsis" cols="110" rows="20"></textarea>
					</td>
				</tr>
			</table>
