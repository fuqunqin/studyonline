...
<html>
	<head>
		...
		<script type="text/javascript">
			function adminAddWin(){
				window.location.href="${pageContext.request.contextPath}/admin/frontiermanager/winmanager/addWin.jsp";
			}
			var flag=false;
			function selectAll(){
	...
	<body>
		<form action="${pageContext.request.contextPath}/admin/deleteWins.do"
			method="post">
			<table class="table" cellspacing="1" cellpadding="2" width="99%"
				...
				<c:forEach var="win" items="${wins }">
					<tr class="td_bg" align="center">
						<td>
							<input type="checkbox" name="ids" value="${win.id }"
						...
						<td>
							<a style="color: red"
								href="${pageContext.request.contextPath }/admin/queryWin.do?id=${win.id }">查看</a>
						</td>
						<td>
							<a style="color: red"
								href="${pageContext.request.contextPath }/admin/updateWin.do?id=${win.id }">修改</a>
						</td>
					</tr>
				</c:forEach>
			</table>
		...
		<div align="center">
			...
			<input value="添加科研成果" type="button" onclick="adminAddWin();" />
		</div>
	</body>
</html>
