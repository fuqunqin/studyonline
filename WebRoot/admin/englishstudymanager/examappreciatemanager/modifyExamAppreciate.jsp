...
<html>
	...
	<body>
		<form method="post" onsubmit="javascript:return checkForm();"
			action="${pageContext.request.contextPath }/admin/modifyExamAppreciate.do">
				...
				<tr height="30">
					...
					<td colspan="3">
						<fmt:formatDate value="${examAppreciate.publishDate }"
							pattern="yyyy-MM-dd" />
						<input type="hidden"
							value="<fmt:formatDate value='${examAppreciate.publishDate }'
							pattern='yyyy-MM-dd' />"
							name="publishDateStr" />
					</td>
				</tr>
					...
					<td colspan="4">
						<div class="editor">
							<textarea id="content" name="content"
								style="width: 100%; height: 300px;">${examAppreciate.content }</textarea>
						</div>
					</td>
				</tr>
			</table>
