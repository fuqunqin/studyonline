...
<html>
	...
	<body>
		<form method="post"
			action="${pageContext.request.contextPath }/admin/modifyEnglishStudy.do">
				...
				<tr height="30">
					...
					<td colspan="3">
						<fmt:formatDate value="${englishStudy.publishDate }"
							pattern="yyyy-MM-dd" />
						<input type="hidden"
							value="<fmt:formatDate value='${englishStudy.publishDate }'
							pattern='yyyy-MM-dd' />"
							name="publishDateStr" />
					</td>
				</tr>
					...
					<td colspan="4">
						<div class="editor">
							<textarea id="content" name="content"
								style="width: 100%; height: 300px;">${englishStudy.content }</textarea>
						</div>
					</td>
				</tr>
			</table>
			...
			<input type="hidden" value="${englishStudy.id }"
				name="englishStudyId" />
		</form>
	</body>
</html>
