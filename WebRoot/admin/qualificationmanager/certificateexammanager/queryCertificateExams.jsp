...
<html>
	<head>
		...
		<script type="text/javascript">
			function adminAddCertificateExam(){
				window.location.href="${pageContext.request.contextPath}/admin/qualificationmanager/certificateexammanager/addCertificateExam.jsp";
			}
			var flag=false;
			function selectAll(){
	...
	<body>
		<form method="post"
			action="${pageContext.request.contextPath}/admin/deleteCertificateExams.do">
			<table class="table" cellspacing="1" cellpadding="2" width="99%"
				...
				<c:forEach var="certificateExam" items="${certificateExams }">
					<tr class="td_bg" align="center">
						<td>
							<input type="checkbox" name="ids" value="${certificateExam.id }"
						...
						<td>
							<a style="color: red"
								href="${pageContext.request.contextPath }/admin/queryCertificateExam.do?id=${certificateExam.id }">查看</a>
						</td>
						<td>
							<a style="color: red"
								href="${pageContext.request.contextPath }/admin/updateCertificateExam.do?id=${certificateExam.id }">修改</a>
						</td>
					</tr>
				</c:forEach>
			</table>
		...
		<div align="center">
			...
			<input value="添加资格考试信息" type="button"
				onclick="adminAddCertificateExam();" />
		</div>
	</body>
</html>
