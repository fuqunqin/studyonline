...
<html>
  ...
  <body bgcolor="#016ba9" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
  <center>
...
<table id="__01" width="1003" height="613" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<tr><td colspan="3"><font color="FFFF" size="2">${loginWrong }<html:errors /><a href="${pageContext.request.contextPath }/findpassword/findPassword.jsp" style="color: red;">忘记密码?</a></font></td></tr>
